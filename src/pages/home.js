...
import { getAuth, getCookie, getUserId } from "../helpers/cookie";
    ...
    return (
        <>
            ...
            <div className="heroContainer">
                <div className="heroBanner">
                    <div className="heroText">
                        ...
                        <p className="desc">
                            lorem as asfsa saf fsafs afafaf asf asff f saf afs
                            ffsa fsaa sfsa asaf sa ffssfsaf asf as fafsasfs saff
                        </p>
                        <div className="icons">
            ...
            <div className="contributeContainer">
                ...
                <div className="quote">
                    <h2>
                        "It's not about how much you do but how much love you
                            ...
                            <div className="list">
                                <div className="listItem">
                                    ...
                                    <div>
                                        <h3>Heading</h3>
                                        <p>
                                            lorem as asfsa saf fsafs afafaf asf
                                            asff f saf afs
                                        </p>
                                    </div>
                                </div>
